...
def find_corner_points(images, corners_x=7, corners_y=7):
...
def find_3d_axis(fname, mtx, dist, corners_x=7, corners_y=7):
...
def find_3d_cube(fname, mtx, dist, corners_x=7, corners_y=7):
